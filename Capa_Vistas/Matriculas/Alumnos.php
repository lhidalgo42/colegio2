...
<thead>
  ...
  <td class="span"><input type="text" class="span1" id="<?php echo"rut".$i.""?>" placeholder="Rut"></td>
    ...
    <td class="span1"><input type="number" class="span1" value="0" min="0" id="<?php echo"montoM".$i.""?>" placeholder="Monto"></td>
    <td><input type="date" style="width:115px;" id="<?php echo"fechaM".$i.""?>" placeholder="Fecha"></td>
    <td class="span1"><input type="number" class="span1" value="0" min="0" id="<?php echo"valeS".$i.""?>" placeholder="VALE N°"></td>
    <td class="span1"><input type="number" class="span1" value="0" min="0" id="<?php echo"montoS".$i.""?>" placeholder="Monto"></td>
    <td><input type="date" style="width:115px;" id="<?php echo"fechaS".$i.""?>" placeholder="Fecha"></td>
    <td><input type="number" class="input-small" id="<?php echo"1sem".$i.""?>" placeholder="% Beca"></td>
    <td><input type="number" class="input-small" id="<?php echo"2sem".$i.""?>" placeholder="% Beca"></td>
  </tr>
  <?php 
  }
  ?>
