...
class Insert {
	...
	public static function Papa($rutPapa,$nombrepapa,$apellido1Papa,$apellido2Papa,$sexo,$fechaNac,$aEconomico,$profesionPapa,$FamiliaID,$direccionCasa,$comunaCasa,$email,$trabajoLugar,$direccionTrabajo,$telefonos) {
		...
		public static function Nino($ninoRUT,$ninoNombre,$ninoApellido1,$ninoApellido2,$sexo,$fechaNac,$curso,$PagoMatriculaID,$pagoSeguroEscolarID,$familiaID,$beca1,$beca2,$colegioAnterior) {
		...
		public static function Nino($almuerzoID,$ninoRut) {
        ...
        $queryString = "INSERT INTO documentos (Numero, familia_ID, Colegiatura, Materiales, Cuota_Inc, Almuerzo, Deuda, Vencimiento, Observaciones) VALUES ('".$nboleta."', '".$familiaID."', '".$col."', '".$mat."', '".$cuoINC."', '".$alm."', '".$deu."', 'NULL', '".$observaciones."');";
			$query = CallQueryReturnID($queryString);
			echo $queryString;
			return $query; 
	}
