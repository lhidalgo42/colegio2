...
$pagoMatricula=Query::InsertarPagoMatricula($_POST['alumnos'][$i][8],$_POST['alumnos'][$i][12],$_POST['alumnos'][$i][13]);
$pago=Query::InsertarPago($_POST['alumnos'][$i][11],$_POST['alumnos'][$i][12],$_POST['alumnos'][$i][13],$_POST['alumnos'][$i][10],$tipo);
 	 if($_POST['alumnos'][$i][17]=="Cheque"){$tipo=1;}
	 if($_POST['alumnos'][$i][17]=="Letra"){$tipo=2;}
	 if($_POST['alumnos'][$i][17]=="Efectivo"){$tipo=3;}
$relacion=Query::R_PagoMatricula($pago,$pagoMatricula);	 
 $pagoSeguro=Query::InsertarPagoSeguroEscolar($_POST['alumnos'][$i][14],$_POST['alumnos'][$i][20],$_POST['alumnos'][$i][21],$_POST['alumnos'][$i][16]);
 $pago=Query::InsertarPago($_POST['alumnos'][$i][19],$_POST['alumnos'][$i][20],$_POST['alumnos'][$i][21],$_POST['alumnos'][$i][18],$tipo);
 $relacion=Query::R_PagoSeguro($pago,$pagoSeguro);
$nino=Query::InsertarNino($_POST['alumnos'][$i][0],$_POST['alumnos'][$i][1],$_POST['alumnos'][$i][2],$_POST['alumnos'][$i][3],$_POST['alumnos'][$i][6],$_POST['alumnos'][$i][4],$_POST['alumnos'][$i][7],$pagoMatricula,$pagoSeguro,$idFamilia,$_POST['alumnos'][$i][22],$_POST['alumnos'][$i][23],$_POST['alumnos'][$i][5]);
	}
 }
